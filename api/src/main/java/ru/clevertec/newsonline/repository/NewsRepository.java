...
import ru.clevertec.newsonline.entity.News_;
...
@Repository
public interface NewsRepository extends JpaRepository<News, UUID>, IRepository<News>, IFilterEntityRepository<News, NewsFilter, News_, String> {
    @Override
